...
\begin{itemize}
    ...
    \item \textbf{Expansión de reglas genéricas:} Las reglas con protocolo ``\texttt{ANY}" que especifican puertos se expanden automáticamente a múltiples reglas específicas (\texttt{TCP}, \texttt{UDP}, \texttt{SCTP}). Esto permite:
    \begin{align*}
